...
// i= i+10 ka mtlb ye hai k x 10 pixl k hissab se aagae brhe..
	...
	//car
	  ...
	  //wheel
	  // SOLID_Fill color pettern ...  color pettern net se search krna type mil jae ga..
	  // mere khyal se 7 types hai ...
	  setfillstyle(SOLID_FILL,RED);
	  circle(60+i,400,15); //back tyre
	  // agr circle ya squre fill krna hoto x or y main 2 pxl add kre gy..
	  // agr tringle main color fill krna hoto x main 2 plus kre gy or y main 1 menus kre gy thek..
...
///////////////////    //Road footpath
	...
	school(0,335,640,336);    //road border   // border line hai road ka
